...
export type MetricType = "per90" | "percentage" | "rate";
...
const GK_TEMPLATE: RadarTemplate = {
  ...
  metrics: [
    ...
    { key: "penalty_save_r",  label: "Pen Save Rate",    type: "rate",       statField: "penalty_save",                higherIsBetter: true,  description: "Penalties saved / penalties faced" },
    ...
    { key: "rating",          label: "Rating",           type: "per90",      statField: "rating",                      higherIsBetter: true,  description: "Average match rating" },
  ]
};
...
const CB_TEMPLATE: RadarTemplate = {
  role: "CB",
  metrics: [
    { key: "tack_int_p90",    label: "Tackles + Int",    type: "per90",      statField: "tackles",                     higherIsBetter: true,  description: "Tackles and interceptions per 90 (sum)" },
...
const FB_TEMPLATE: RadarTemplate = {
  role: "FB",
  metrics: [
    { key: "tack_int_p90",    label: "Tackles + Int",    type: "per90",      statField: "tackles",                     higherIsBetter: true,  description: "Tackles and interceptions per 90" },
...
const AMW_TEMPLATE: RadarTemplate = {
  ...
  metrics: [
    ...
    { key: "key_passes_p90",  label: "Key Passes",       type: "per90",      statField: "key_passes",                  higherIsBetter: true,  description: "Key passes per 90 minutes" },
    { key: "dribbles_p90",    label: "Dribbles",         type: "per90",      statField: "successful_dribbles",         higherIsBetter: true,  description: "Successful dribbles per 90 minutes" },
    { key: "goal_contrib_p90",label: "Goal Contributions",type: "per90",     statField: "goals",                       higherIsBetter: true,  description: "Goals + assists per 90 minutes (computed)" },
    { key: "xa_p90_2",        label: "Assists",          type: "per90",      statField: "assists",                     higherIsBetter: true,  description: "Assists per 90 minutes" },
    { key: "rating",          label: "Rating",           type: "per90",      statField: "rating",                      higherIsBetter: true,  description: "Average match rating" },
  ]
};
...
const ST_TEMPLATE: RadarTemplate = {
  ...
  metrics: [
    ...
    { key: "shots_p90",       label: "Shots",            type: "per90",      statField: "total_shots",                 higherIsBetter: true,  description: "Shots per 90 minutes" },
    { key: "shot_acc",        label: "Shot Accuracy",    type: "rate",       statField: "shots_on_target",             higherIsBetter: true,  description: "Shots on target / total shots" },
    { key: "conversion",      label: "Conversion %",     type: "rate",       statField: "goals",                       higherIsBetter: true,  description: "Goals / shots on target" },
...
export const RADAR_MINUTE_TIERS = {
  MINIMUM_SHOW: 90,       // below this: do not render radar at all
  PERCENTILE_ENABLE: 270, // below this: show values but not percentile rank
  FULL_CONFIDENCE: 450,   // at or above this: full percentile rank display
} as const;
